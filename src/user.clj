...
(defn main [& args]
  ...
  (comment (.stop server))
  (alter-var-root #'datomic-client (constantly (datomic.client.api/client {:server-type :dev-local :storage-dir "/Users/ahmetoguzhanengin/Desktop/Student-Registration-Electric/form-template/form-db" :system "ci"})))
